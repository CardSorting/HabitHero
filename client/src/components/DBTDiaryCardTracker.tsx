    ...
    <>
      ...
      <TabsContent value="sleep" className="space-y-4">
        <Card>
          <CardContent className="p-4">
            <h3 className="text-lg font-medium mb-4">Quality of Sleep</h3>
            <ScrollArea className="h-[calc(100vh-300px)]">
              <Table className="min-w-full divide-y divide-gray-200">
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Number of hours slept</TableCell>
                    {dayHeaders.map(day => (
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Trouble falling asleep</TableCell>
                    {dayHeaders.map(day => (
                      <TableCell key={day.date} className="px-1">
                        <Select 
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Trouble staying asleep</TableCell>
                    {dayHeaders.map(day => (
                      <TableCell key={day.date} className="px-1">
                        <Select 
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Trouble waking up</TableCell>
                    {dayHeaders.map(day => (
                      <TableCell key={day.date} className="px-1">
                        <Select 
                  ...
                  <TableRow>
                    <TableCell className="font-medium border-t">Taking medication as prescribed</TableCell>
                    {dayHeaders.map(day => (
                      <TableCell key={day.date} className="px-1 border-t">
                        <Select 
                          value={getMedicationValue(day.date)}
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium">Feelings and Emotions</h3>
              <div className="text-sm text-muted-foreground">
                Scale: 0 = none, 1 = a little, 3 = some, 5 = moderate, 7 = strong, 10 = very strong
              </div>
            </div>
            <ScrollArea className="h-[calc(100vh-300px)]">
              <Table className="min-w-full divide-y divide-gray-200">
                <TableHeader>
                  <TableRow>
                    <TableHead className="w-1/3">Emotion</TableHead>
                    {dayHeaders.map(day => (
                      <TableHead key={day.date} className="px-1 text-center">
                        <div className="font-medium">{day.abbr}</div>
                      </TableHead>
                ...
                <TableBody>
                  {['Joy / Happiness', 'Anxiety', 'Sadness', 'Guilt', 'Anger', 'Fear', 'Peace / Contentment'].map(emotion => (
      ...
      <TabsContent value="urges" className="space-y-4">
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium">Urges and Thoughts</h3>
              <div className="text-sm text-muted-foreground">
                Scale: 0 = none, 1 = a little, 3 = some, 5 = moderate, 7 = strong, 10 = very strong
              </div>
            </div>
            <ScrollArea className="h-[calc(100vh-300px)]">
              <Table className="min-w-full divide-y divide-gray-200">
                <TableHeader>
                  <TableRow>
                    <TableHead className="w-1/3">Urge / Thought</TableHead>
                    {dayHeaders.map(day => (
                      <TableHead key={day.date} className="px-1 text-center">
                        <div className="font-medium">{day.abbr}</div>
                        <div className="font-normal text-xs">Level / Action</div>
                      </TableHead>
                    ))}
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {['Self-Harm', 'Suicide', 'Other'].map(urge => (
                    <TableRow key={urge}>
                      <TableCell className="font-medium">{urge}</TableCell>
                      {dayHeaders.map(day => (
                        <TableCell key={day.date} className="px-1">
